...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-sale_credit_limit_validation',
    download_url='https://github.com:nantic/trytond-sale_credit_limit_validation.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-sale_credit_limit_validation.git'
    },
    classifiers=[
